...
$date = $_POST['date'];
 ...
 $query = "INSERT INTO book (name,email,contactno,mydropdown,date) VALUES ('$name','$email','$contactno','$mydropdown','$date')";
...
<form method="POST" action="booking.php"> 
     <p> <font color="INDIANRED"> Thanks, for Booking! We will let you know about your status within 24hours. :)
