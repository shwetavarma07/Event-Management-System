...
<p>Click  <a href="admin.html"><u> here </u></a> to go back to Homepage.</p>
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Feedback Details!</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
<form method="POST" action="viewfeedback.php">  </form> 
<!-- End page content -->
</div>
...
<?php
  $select=mysql_query("SELECT * FROM feedback order by id ");
